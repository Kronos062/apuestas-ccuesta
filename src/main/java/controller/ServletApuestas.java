...
public class ServletApuestas extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if(context.getAttribute("apuestas") == null) {
            context.setAttribute("apuestas", service.getAllApuestas());
        }
        ...
        switch(action) {
            ...
            case "filter":
                ...
                context.setAttribute("apuestasFiltradas", filtradas);
                break;
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        context.setAttribute("apuestas", service.getAllApuestas());
        context.removeAttribute("apuestasFiltradas");
